...
function Dashboard() {
  ...
  const fetchEntries = async () => {
    try {
      ...
      const response = await axios.get('https://mindcare-mini-project-1.onrender.com/api/journal/entries', {
  ...
  const fetchTrends = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await axios.get('https://mindcare-mini-project-1.onrender.com/api/journal/trends', {
        headers: { 'Authorization': `Bearer ${token}` }
      });
  ...
  const fetchActivities = async (entryId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await axios.get(`https://mindcare-mini-project-1.onrender.com/api/journal/activities/${entryId}`, {
        headers: { 'Authorization': `Bearer ${token}` }
      });
  ...
  const fetchWritingPrompt = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await axios.get('https://mindcare-mini-project-1.onrender.com/api/journal/writing-prompt', {
        headers: { 'Authorization': `Bearer ${token}` }
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem('token');
      await axios.post('https://mindcare-mini-project-1.onrender.com/api/journal/entries', 
        { content },
        {
          headers: {
  ...
  const handleDelete = async (entryId) => {
    ...
    try {
      const token = localStorage.getItem('token');
      await axios.delete(`https://mindcare-mini-project-1.onrender.com/api/journal/entries/${entryId}`, {
        headers: { 'Authorization': `Bearer ${token}` }
      });
